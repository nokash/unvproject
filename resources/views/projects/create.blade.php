...
{!! Form::open([ 'action' => 'ProjectsController@store', 'method' => 'POST' ]) !!}
      {!! Form::text('title', '', ['class' => 'form-control', 'placeholder' => 'Enter the Title Here']) !!}  <br>
      {!! Form::text('project_id', '', ['class' => 'form-control', 'placeholder' => 'Enter Project ID']) !!} <br>
      {!! Form::text('amount', '', ['class' => 'form-control', 'placeholder' => 'Enter the Grand Amount Here']) !!} <br>
      ...
      <p>
      {!! Form::text('first_disbursement', '', ['class' => 'form-control', 'placeholder' => 'Enter the First Disbursement Amount']) !!}  <br>
      {!! Form::text('readiness_type', '', ['class' => 'form-control', 'placeholder' => 'Type of Readiness']) !!}  <br>
      {!! Form::text('status', '', ['class' => 'form-control', 'placeholder' => 'Project Status']) !!}  <br>
      </p>
